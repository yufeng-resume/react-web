...
import { DownloadLink, ExternalLink } from 'src/elements/Link';
...
export const Opencerts = ({ queryPath }: Props) => {
  ...
  return (
    <Container>
      ...
      <StyledExternalLink href="https://www.opencerts.io">www.opencerts.io (opens in new tab)</StyledExternalLink>
      {downloadURLs.map((url, index) => (
        <DownloadLinkContainer key={index}>
          ...
          <StyledImagePreview imagePath={`opencerts/${filenames[index]}.jpg`}>Hover to preview</StyledImagePreview>
